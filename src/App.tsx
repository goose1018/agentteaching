        ...
        {view === 'home' && (
          <section className="teacher-grid">
            ...
            <div className="panel">
              ...
              <button className="record-button" type="button" onClick={extractCard}>AI 提取我的讲题方法</button>
            </div>
          </section>
        )}
            ...
            <div className="panel">
              ...
              <aside className="method-detail static">
                ...
                <div className="review-actions">
                  <button type="button" onClick={approveCard}>像我，发布</button>
                  <button type="button" onClick={sendBack}>需要修改</button>
                  <button type="button" onClick={disableCard}>不像我，重做</button>
                </div>
              </aside>
            </div>
          </section>
                ...
                {answerReviews.map((item) => (
                  <article className="chatlog-item" key={item.id}>
                    ...
                    <footer>
                      <em>{item.risk}</em>
                      <div>
                        <button type="button" onClick={() => updateReviewStatus(item.id, 'approved')}>通过</button>
                        <button type="button" onClick={() => updateReviewStatus(item.id, 'needs_fix')}>要求修改</button>
                        <button type="button" onClick={() => updateReviewStatus(item.id, 'rejected_example')}>加入反例库</button>
                      </div>
                    </footer>
                  </article>
                ))}
